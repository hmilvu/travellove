function save(){
	...
	$.ajax({
			type:'POST',
			url:'admin/view-spot!update.action',
...
map.centerAndZoom(new BMap.Point(parseFloat(longEdit), parseFloat(latiEdit)), 15);// longEdit and latiEdit are define in view-spot-edit.jsp
addMarker(new BMap.Point(parseFloat(longEdit), parseFloat(latiEdit)), 0);
