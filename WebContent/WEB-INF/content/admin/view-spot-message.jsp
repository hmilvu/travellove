...
<form id="pagerForm" method="post" action="admin/view-spot!message.action">
	<input type="hidden" name="uid" value="<s:property value='%{#request.editView.id}'/>" />
		...
		<table class="table" width="1100" layoutH="70">
			...
			<tbody>
				...
				<tr target="sid_user" rel="<s:property value="%{#msg.id}"/>">
					...
					<td>
						<a title="确定要删除此评论吗？" target="ajaxTodo" href="admin/view-spot!deleteMessage.action?id=<s:property value="%{#msg.id}"/>" class="btnDel">删除</a>
					</td>				
				</tr>
				</s:iterator>
				</tbody>
