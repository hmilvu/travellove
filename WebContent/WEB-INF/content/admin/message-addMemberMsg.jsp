...
function save(){
	...
	$.ajax({
			type:'POST',
			url:'admin/message!createMemberMsg.action',
	...
	<form name="userForm" id="userForm" method="post" action="" class="pageForm required-validate">
		<div class="pageFormContent nowrap" layoutH="56">			
			...
			<dl>
				<dt>团员列表：</dt>
				<dd>
					<input name="selectmember.id" value="" type="hidden">
					<input name="selectmember.orgName" type="text" class="readonly required" readonly="readonly" size="40"/>
