...
function save(){
	...
	$.ajax({
			type:'POST',
			url:'admin/message!updateTeamMsg.action',
	...
	<form name="userForm" id="userForm" method="post" action="" class="pageForm required-validate">
		...
		<div class="pageFormContent nowrap" layoutH="56">	
			...
			<dl>
				<dt>旅行团列表：</dt>
				<dd>
					<input name="selectteam.id" type="hidden" value="<s:property value='%{#request.editMessage.receiverId}'/>">
					<input name="selectteam.orgName" type="text" class="readonly required" readonly="readonly" size="40" value="<s:property value='%{#request.editMessage.receiverName}'/>"/>
