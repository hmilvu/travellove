...
import com.travel.entity.Channel;
...
public class ChannelDAO extends BaseDAO {
	...
	public List<Channel> findByExample(Channel instance) {
		...
		try {
			List<Channel> results = (List<Channel>) getSession()
					.createCriteria("com.travel.entity.Channel").add(
